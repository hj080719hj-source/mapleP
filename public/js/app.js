...
function shell() {
  ...
  <header class="sidebar"><a class="brand" href="./"><img src="./favicon.svg" alt="" width="38" height="38"><span>메이플유<small>MAPLE YOU</small></span></a><nav class="calculator-tabs" aria-label="계산기"><a href="./" aria-current="page">장비 기대값</a><a href="./gold-cube.html">큐브 기대값</a></nav></header>
  <div class="workspace">
