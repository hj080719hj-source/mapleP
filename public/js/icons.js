...
export function equipmentIcon(item) {
  ...
  if (['original-sin','blood-wraith','mitra','michaela','genesis'].includes(item.id)) return `<img class="equipment-icon-image" src="./assets/${item.id}.png" alt="" width="24" height="24">`;
